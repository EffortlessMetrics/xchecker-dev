...
use xchecker_engine::crate::config::{CliArgs, Config};
use xchecker_engine::crate::error::{ConfigError, XCheckerError};
use xchecker_engine::crate::receipt::ReceiptManager;
use xchecker_engine::crate::spec_id::sanitize_spec_id;
use xchecker_engine::crate::status::artifact::ArtifactManager;
use xchecker_engine::crate::types::{PhaseId, StatusOutput};
...
impl xchecker_gate::SpecDataProvider for &OrchestratorHandle {
    ...
    fn pending_fixups_result(&self) -> xchecker_gate::PendingFixupsResult {
        use xchecker_engine::crate::fixup::pending_fixups_result_from_handle;
