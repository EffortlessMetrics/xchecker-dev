...
## 2024-05-24 - Static Caching of Regex
**Learning:** Compiling regexes inside high-traffic functions on every call creates a CPU exhaustion bottleneck.
**Action:** Always use `std::sync::LazyLock` to statically cache compiled regexes in frequently executed code paths to minimize execution overhead.
