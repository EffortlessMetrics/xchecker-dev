...
## 2024-07-26 - Regex Compilation Overhead in Extraction
**Learning:** Recompiling regular expressions on every invocation of extraction functions causes significant and unnecessary CPU overhead.
**Action:** Use `std::sync::LazyLock` to statically cache compiled regular expressions within function scopes to eliminate recompilation costs while keeping the refactoring localized.
