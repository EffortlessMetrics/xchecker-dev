...
fn execute_clean_command(spec_id: &str, hard: bool, force: bool, _config: &Config) -> Result<()> {
    ...
    if artifacts_path.exists() {
        ...
        println!("{} Removed artifacts directory", "✓".with(Color::Green).bold());
    }
    ...
    if receipts_path.exists() {
        ...
        println!("{} Removed receipts directory", "✓".with(Color::Green).bold());
    }
    ...
    if context_path.exists() {
        ...
        println!("{} Removed context directory", "✓".with(Color::Green).bold());
    }
    ...
    if base_path.exists() {
        if hard {
            ...
            match std::fs::remove_dir(&base_path) {
                Ok(()) => {
                    println!("{} Removed empty spec directory", "✓".with(Color::Green).bold());
                }
                Err(_) => {
...
fn execute_init_command(spec_id: &str, create_lock: bool, config: &Config) -> Result<()> {
    ...
    println!("{}", format!("Initializing spec: {spec_id}").with(Color::Cyan).bold());
    ...
    if spec_dir.exists() {
        ...
        println!("  {} Created artifacts directory", "✓".with(Color::Green).bold());
        println!("  {} Created receipts directory", "✓".with(Color::Green).bold());
        println!("  {} Created context directory", "✓".with(Color::Green).bold());
    }
    ...
    if create_lock {
        ...
        println!("  {} Created lockfile: lock.json", "✓".with(Color::Green).bold());
        println!("    Model: {model}");
